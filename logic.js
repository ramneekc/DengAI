d3.csv("/Prophet/sj_train.csv").then(train => {
    ...
    d3.csv("/Prophet/sj_test.csv").then(test => {
        ...
        d3.csv("/Prophet/sj_predictions.csv").then(predictions => {
            ...
            createChartsSJFB(train_list, test_list, predicted_list);
        })
...
function createChartsSJFB(train, test, predict) {
...
d3.csv("/Prophet/iq_train.csv").then(train => {
    ...
    d3.csv("/Prophet/iq_test.csv").then(test => {
        ...
        d3.csv("/Prophet/iq_predictions.csv").then(predictions => {
            ...
            createChartsIQFB(train_list, test_list, predicted_list);
        })
...
function createChartsIQFB(train, test, predict) {

    Highcharts.chart('container-FBIQ', {
        chart: {
            type: 'spline'
        },
        title: {
